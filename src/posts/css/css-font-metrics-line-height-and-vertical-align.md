...
在我们的例子中，Catamaran 字体定义了 0 单位的 line gap，所以 `line-height: normal` 就等于 content-area，也就是 1640 单位，或1.64。
...
问题不仅仅在于 `line-height： 1`。更糟糕的是，在我电脑中安装的 1117 个字体中（是的，我安装了所有来自 Google Web Fonts 的字体），其中有 1059 个字体，差不多 95% 计算后的 `line-height` 都大于1。他们的值在 0.618 到 3.378 之间。你没看错，3.378！

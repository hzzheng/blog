...
- 跨端带来的研发效能提升。因为有 iOS 和 Android 两个阵营，并且技术栈不同，所以很多公司都会维持两个客户端开发团队。这对人力其实是一种浪费，如果能统一技术栈，那么可能只需要一半的人就可以做全部的工作。同时，Flutter 相比原生开发要简单很多，开发者只要有一定的 UI 编程经验，很容易上手开发。如果使用 Flutter，可以整合 iOS、Android、Web 的开发资源，国外有团队使用 Flutter 后声称实现了3倍研发能力的提升。另外，这也能很大程度解决中小厂商的招聘问题。
